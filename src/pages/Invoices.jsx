    ...
    return (
      <div className="india-proforma-invoice a4-container">
              ...
              <table className="details-table" style={{ borderCollapse: 'collapse', marginLeft: 'auto' }}>
                <tbody>
                  ...
                  <tr style={{ color: '#d32f2f', background: 'rgba(211, 47, 47, 0.05)' }}>
                    ...
                    <td style={{ padding: '4px 8px', fontSize: '12px', textAlign: 'left', fontWeight: '800' }}>{data.currency} {(total - (Number(data.amountPaid) || 0)).toLocaleString(undefined, {minimumFractionDigits: 2})}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <table className="item-table" style={{ width: '100%', borderCollapse: 'collapse', minWidth: '500px' }}>
            <thead>
              <tr>
                ...
                <th style={{ padding: '6px', textAlign: 'left', fontSize: '12px', width: '60px' }}>SAC</th>
                <th style={{ padding: '6px', textAlign: 'left', fontSize: '12px', width: '100px' }}>Rate</th>
                <th style={{ padding: '6px', textAlign: 'right', fontSize: '12px', width: '120px' }}>Taxable Amount</th>
              </tr>
            </thead>
            <tbody>
              {data.items.map((item, idx) => (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px' }}>
          <div className="bank-details" style={{ flex: '1', minWidth: '250px', fontSize: '11px', background: '#fafafa', padding: '15px', borderRadius: '4px', border: '1px solid #eee' }}>
          ...
          <div className="summary-section" style={{ flex: '0 1 280px', minWidth: '200px', marginLeft: 'auto' }}>
            <table className="summary-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                <tr>
                ...
                <tr className="total-row" style={{ backgroundColor: '#f9f9f9', fontWeight: 'bold', color: '#000', borderTop: '1px solid #333' }}>
                  <td style={{ padding: '6px 8px', fontSize: '13px' }}>Grand Total:</td>
                  <td style={{ textAlign: 'right', padding: '6px 8px', fontSize: '13px' }}>{data.currency} {total.toLocaleString(undefined, {minimumFractionDigits: 2})}</td>
                </tr>
              </tbody>
            </table>
          </div>
